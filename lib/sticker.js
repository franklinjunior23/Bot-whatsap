    ...
    return new Promise(async (resolve, reject) => {
        ...
        Fffmpeg.on("error", function (err) {
            ...
            .addOutputOptions([
                ...
                `libwebp`,
                `-vf`,
                `scale='min(520,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`,
            ])
            .toFormat("webp")
            .save(out);
    });
    ...
    return new Promise(async (resolve, reject) => {
        ...
        Fffmpeg.on("error", function (err) {
            ...
            .addOutputOptions([
                ...
                `libwebp`,
                `-vf`,
                `scale='min(404,iw)':min'(224,ih)':force_original_aspect_ratio=decrease,fps=15, pad=224:224:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`,
            ])
            .toFormat("webp")
            .save(out);
    });
